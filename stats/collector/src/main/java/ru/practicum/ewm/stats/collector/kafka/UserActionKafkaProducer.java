...
public class UserActionKafkaProducer {
    ...
    public void send(UserActionProto proto) {
        ...
        Long key = proto.getUserId();
        kafkaTemplate.send(userActionsTopic, key, payload);
        log.debug("Sent UserActionAvro to topic {}: userId={}, eventId={}, actionType={}",
    ...
    private byte[] encode(UserActionAvro avro) {
        ...
        try {
            ...
            log.error("Failed to encode UserActionAvro: userId={}, eventId={}, actionType={}, timestamp={}",
                    avro.getUserId(), avro.getEventId(), avro.getActionType(), avro.getTimestamp(), e);
